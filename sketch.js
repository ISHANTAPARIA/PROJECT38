...
function setup() {
  ...
  ground = createSprite(windowWidth / 2, 600, windowWidth + 900, 100);
  ...
  camera.position.y = player.y + 40;
  camera.position.x = player.x + 400;
  //console.log(windowWidth);

  startB = createSprite(windowWidth / 2 - 100, 350, 100, 30);
  startB.addImage(startB_image);
  startB.scale = 0.5;
  startB.visible = true;

  retryB = createSprite(windowWidth / 2 - 100, 300, 100, 30);
